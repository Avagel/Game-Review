...
export const NavBarMain = () => {
  ...
  return (
    <div
      ...
      } top-[90%] z-5  w-full justify-center flex gap-2 lg:top-0    `}
    >
      {isSearch ? (
        ...
        <div className="h-14 w-[90%] rounded-3xl lg:rounded-none lg:bg-zinc-900/90 shadow-md bg-zinc-900/80  backdrop-blur-lg flex items-center justify-between md:justify-center gap-0  overflow-auto shrink-0 px-5 [scrollbar-width:none] [-webkit-scrollbar:display:none] transition-all duration-300 lg:w-full lg:justify-center lg:gap-6 ">
          <button
            onClick={() => {
              navigate("/");
            }}
            className={`w-12 h-10 rounded-full shrink-0 flex flex-col hover:text-amber-500  items-center mr-3 justify-center ${
          ...
          <button
            ...
            className={`w-12 rounded-full h-10   hover:text-amber-500 shrink-0  items-center mr-3 justify-center flex flex-col ${
          ...
          <button
            ...
            className={`w-12 h-10 rounded-full hover:text-amber-500  shrink-0 flex flex-col items-center  justify-center  ${
