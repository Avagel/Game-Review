...
export const Home = ({ games, loading, error, news, newsLoading }) => {
  ...
  return error ? (
    ...
    <>
      <div className="h-screen tracking-wider overflow-x-hidden  overflow-auto [scrollbar-width:none] [-webkit-scrollbar:display:none] px-2 relative pb-30">
        <img
          className="absolute blur-[120px] top-25 right-[40%] rounded-md z-0 h-70/100 lg:h-full overflow-hidden opacity-50"
          src={images[index]}
          alt=""
        />
        <div className="h-fit w-full  pt-30 pb-10 flex flex-col items-center gap-5 ">
          <p className="text-white/80 text-center text-5xl w-fit tracking-widest">
            Play, <br /> Review, <br />
            Repeat.
          </p>
          <p className="text-center text-base w-[168px] text-zinc-400">
        ...
        <div className="relative mt-25 lg:px-30">
          <img
            className="absolute blur-[120px] top-25 left-[80%] rounded-md z-0 h-70/100 lg:h-full overflow-hidden opacity-50"
            src={images[index]}
            alt=""
          />
          <p className="text-xl lg:text-3xl text-white text-center mb-1">
            Trending Games
          </p>
          <p className="text-base lg:text-3xl text-zinc-400 text-center">
        ...
        <div className="h-fit relative pb-3 w-full mt-25 rounded-md  lg:flex lg:items-center lg:flex-col">
          ...
          <div className="flex flex-col h-70 gap-3 px-3 mt-10 overflow-auto [scrollbar-width:none] [-webkit-scrollbar:display:none]  lg:mt-5">
            {/* Item*/}
            <div className=" relative shrink-0 w-full  h-60 rounded-3xl overflow-hidden border border-orange-500">
              <img
              ...
              <div className="z-3 w-full h-full absolute inset-0">
                ...
                <div className="m-5 w-[60%]">
                  ...
                  <p className="text-xs text-zinc-400">
                    Embark on epic journeys filled with exploration,
        ...
        <div className="relative mt-25">
          ...
          <div className="w-full h-fit flex justify-center items-center gap-3">
            ...
            <div className="flex flex-col items-center w-[70%]  ">
              <img
                src={sekiro}
                className="mt-10 h-30 w-full rounded-lg bg-sky-500 object-cover"
              ></img>
        ...
        <div className="relative mt-25">
          ...
          <div className="flex flex-col items-center z-3">
            ...
            <p className="text-base lg:text-3xl text-zinc-400 text-center w-[70%] mb-10">
